        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-social">
              <a href="https://instagram.com/jharkhandjobs03" target="_blank" rel="noreferrer" aria-label="Instagram">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#86EFAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                <a href="mailto:jharkhandjobs03@gmail.com" style={{ fontWeight: '600', color: '#86EFAC' }}>
                  jharkhandjobs03@gmail.com
                </a>
              </li>
              <li style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#bbf7d0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                <a href="https://instagram.com/jharkhandjobs03" target="_blank" rel="noreferrer" style={{ fontWeight: '600', color: '#bbf7d0' }}>
                  @jharkhandjobs03
                </a>
              </li>
